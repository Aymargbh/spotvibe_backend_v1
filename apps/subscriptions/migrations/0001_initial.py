    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('utilisateur', models.ForeignKey(help_text='Utilisateur abonné', on_delete=django.db.models.deletion.CASCADE, related_name='subscriptions', to=settings.AUTH_USER_MODEL, verbose_name='Utilisateur')),
                ('plan', models.ForeignKey(help_text="Plan d'abonnement souscrit", on_delete=django.db.models.deletion.CASCADE, related_name='subscriptions', to='subscriptions.subscriptionplan', verbose_name='Plan')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscription', models.ForeignKey(help_text='Abonnement concerné', on_delete=django.db.models.deletion.CASCADE, related_name='history', to='subscriptions.subscription', verbose_name='Abonnement')),
                ('utilisateur_action', models.ForeignKey(blank=True, help_text="Utilisateur qui a effectué l'action (admin)", null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subscription_actions', to=settings.AUTH_USER_MODEL, verbose_name="Utilisateur de l'action")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ordre', models.PositiveIntegerField(default=0, help_text="Ordre d'affichage dans les listes", verbose_name="Ordre d'affichage")),
                ('plan', models.ForeignKey(help_text="Plan d'abonnement", on_delete=django.db.models.deletion.CASCADE, related_name='features', to='subscriptions.subscriptionplan', verbose_name='Plan')),
            ],
            options={
